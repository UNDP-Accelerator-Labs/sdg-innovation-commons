# Learning from the ingenuity of women and men in ‘least developed countries’

[[type:blog]]

[[source:https://www.undp.org/acceleratorlabs/blog/grassrootsinnovationLDC]]

[Original article published here](https://www.undp.org/acceleratorlabs/blog/grassrootsinnovationLDC)
...
Emmanuel Alie Mansaray built Sierra Leone’s first solar-powered car entirely from waste. Photo: for Tomorrow.
...
Emmanuel Alie Mansaray(link is external) is a 24-year-old self-taught engineer living in Freetown, Sierra Leone. He built the Imagination Car, Sierra Leone's first locally made solar-powered car, entirely from waste.
...
Many innovators in least developed countries such as Nepal, Ethiopia, Tanzania(link is external) and Togo to name a few, are taking this circular approach. They use waste such as plastic bottles, rice bran or plastic bags to make furniture, roads, even to create new buildings.
...
With the major setbacks on our course to the 2030 Agenda, we need to double down on learning –- and sooner rather than later –- from the innovations already being created in all countries, including those that classify as “least developed” so we can finally retire this concept(link is external).

Put simply: without learning from people who are already solving problems, we won't achieve the Global Goals. The question is how do we orchestrate this collective intelligence more strategically and at scale(link is external)?

If you are interested in learning from grassroots innovations, join us. If you are also engaged in redefining who is an expert when it comes to sustainable development, we want to hear from you(link is external). Join us in this endeavour to learn from innovations in LDCs and beyond!
