# Q3 2024 – Artificial Intelligence, data and digitalization

[[focal_point:lorena.moscovich@undp.org]]
...
[[datasources:in depth interviews]]
[[datasources:challenge completion  data]]
[[datasources:digital]]
...
![Missing alt text](https://undp-accelerator-labs.github.io/Archive_SDG_Commons_2024/blobs/learningplans/0458bf4e96c49574a7750c2069caac8f.png)
...
![Missing alt text](https://undp-accelerator-labs.github.io/Archive_SDG_Commons_2024/blobs/learningplans/7c5ad17e5e3478e24fe6e3b959206007.png)
...
In collaboration with the Universidad de San Andrés, we convened a seminar to explore the opportunities and challenges of AI in healthcare, public policies, justice and related fields. The event drew over 100 in-person attendees and fostered engagement across various university departments, including the Master’s program in Public Administration, the Center for Human Development Studies (CEDH, by its Spanish acronym), the Center for Technology and Society Studies (CETyS, by its Spanish acronym), the Department of Engineering, and the Data Science Lab within the Department of Mathematics and Sciences. 

 

Also, in collaboration with the Data Science Lab of the Universidad de San Andrés and the Subsecretariat of Science and Technology of the Nation, we organized the contest 'Contar con Datos' (which translates to 'Tell Stories with Data' and 'Count on Data to Make Decisions'). The aim was to expand the data community and promote collaborative data exploration. The contest focuses on four key dimensions: identifying positive outliers who achieve superior results in similar conditions; promoting resilience by using real-time data and AI to anticipate and respond to crises; enhancing transparency in governance through public data visualization to foster citizen engagement; and highlighting citizen science, emphasizing the role of collective knowledge in solving local issues. Additionally, it underscores the need for effective communication, using diverse visualization techniques to make data clear, compelling, and accessible. 

 

The event received an overwhelming response, with over 140 submissions, showcasing a diverse range of visualizations on critical topics such as lithium, climate change, migration, poverty, and the environment. The submissions included powerful infographics and artistic visualizations, all designed to tell impactful stories. This event underscores the growing importance of data literacy in Argentina, helping to bridge the gap between raw data and meaningful insights that can inspire change. 
...
National officials on Open Data and Public Sector Innovation 
...
Our ongoing discussions with officials in Open Data and Public Sector Innovation focus on identifying shared interests, fostering open dialogue, and facilitating collaborative efforts. The Ministry of Foreign Affairs was also interested in collaborating on AI topics, so we organized a seminar together. This approach avoids pre-defined agendas and allows for organic exploration of potential projects and innovative ideas. 
...
In collaboration with Citibeats, a social listening company, a study was conducted to analyze public sentiment on social media regarding Artificial Intelligence (AI) within Argentina. Additionally, Humai, a learning platform, and MultiplAI Health, a health diagnostics startup utilizing AI, were invited as private sector partners to contribute to a seminar on the impact of AI on development. 
...
As we move forward within our challenge, the Lab will continue to work in fostering an open and inclusive public debate on AI's applications and regulations. We aim to raise awareness and understanding of AI's potential to contribute to development goals, while also evaluating existing regulatory frameworks to ensure they balance innovation, safety and ethical considerations. 

 

 

Collaboration with experts and partners has proven instrumental in mapping the national AI ecosystem. We hope that the ongoing exploratory conversations officials in Open Data and Public Sector Innovation allow us to foster partnerships to scale up our efforts. With our contributions, we aim to nurture the AI national ecosystem. By highlighting key experts, projects and organizations, and by connecting stakeholders across the ecosystem, the Lab’s work is laying the foundations for a robust national AI landscape.  

 

 

Last year, active engagement with our colleagues within the Country Office was a hallmark of our work. We encourage open dialogue and feedback, fostering participation in the challenge. We also organized training sessions to enhance the Country Office’s capabilities in approaching AI. Building on this success, we will continue to share progress and results with our colleagues, and plan to organize another training session to explore how AI can enrich the Country Office’s work. 
