# Coaliciones activadas por el cambio climático

[[type:blog]]

[[source:https://www.undp.org/es/uruguay/blog/coaliciones-activadas-por-el-cambio-climatico]]

[Original article published here](https://www.undp.org/es/uruguay/blog/coaliciones-activadas-por-el-cambio-climatico)
...
Relatoría gráfica del evento final de la iniciativa Investigación por el Clima.
...
Dentro de la Contribución Determinada a Nivel Nacional(link is external) (NDC, por sus siglas en inglés) hay dos medidas que involucran especialmente a la academia e investigación para el fortalecimiento de capacidades y generación de conocimiento:

Promoción de líneas de investigación.(link is external)

Redes de investigación, desarrollo e innovación.(link is external)

Tratando de responder estas preguntas y tomando en cuenta la NDC, junto a la Agencia Nacional de Investigación e Innovación (ANII)(link is external) y el Ministerio de Ambiente (MA),(link is external) y en el marco de la Promesa Climática(link is external), lanzamos(link is external) “Investigación por el Clima(link is external)” una convocatoria para apoyar investigaciones que buscaran generar un impacto positivo en la mitigación o adaptación al cambio climático, así como la reducción de sus efectos y la alerta temprana.

Esta convocatoria(link is external) nos permitió estimular la postulación de grupos de investigación en diversas áreas del conocimiento para:
...
Presentación de las dos investigaciones seleccionadas por el tribunal de evaluación(link is external):
...
Les invitamos a acceder al reporte de Investigación por el Clima aquí(link is external).
