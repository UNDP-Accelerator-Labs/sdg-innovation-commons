...
[[source:https://www.undp.org/ukraine/blog/turn-right-old-spruce-tree]]

[Original article published here](https://www.undp.org/ukraine/blog/turn-right-old-spruce-tree)
...
Author
OLEKSIY MOSKALENKO
en: Head of Solutions Mapping, UNDP’s Accelerator Labs uk: керівник пошуку рішень, Лабораторія інноваційного розвитку ПРООН
Adding informal place names to Ukraine’s maps could cut emergency service response time
Photo: Oleksiy Moskalenko / UNDP Ukraine
...
The map of Kyiv in 1960s with street and park names that are different now (red), and those that remained the same (green). Source: http://semiletov.org/kievograd/maps/1966-transport.jpg
Map experiment
...
A map of the village of Steni with informal place names
...
The main landmark in the village of Steni, which has three informal names: “Little Chapel”, “Old Cross” and “Old Spruce”. The chances of it remaining the key reference point for the next generation are very high.
...
Our experimental map can be downloaded via the following link. Guidance (in Ukrainian) on editing maps with informal place names is here, and help with printing is here (Inkatlas, MyOSMatic, OsmAnd).
Please share your comments and suggestions with us at acclab.ua@undp.org!
BLOG
Experiment brings in IT User Experience professionals to capture tourist feedback on famous boat trip
The Dnipro, Ukraine’s largest river, which bisects the capital Kyiv, used to swarm with river boats carrying passengers and tourists from one city to another, but...
READ MORE
BLOG
...
UNDP in Ukraine recently launched an initiative to work with the private sector on a just, resilient and green economic recovery. While this initiative aims at bu...
READ MORE
United Nations
