...
[[source:https://www.undp.org/blog/urban-resilience-addressing-old-challenge-renewed-urgency]]

[Original article published here](https://www.undp.org/blog/urban-resilience-addressing-old-challenge-renewed-urgency)
...
Urban resilience – the ability of city dwellers to withstand economic, social, health, environmental, disaster and climate related risks – has assumed renewed urgency and has become central to our development discourse. We know that the impact of COVID-19 has been predominantly urban (nearly 90 percent of people affected, according to a UNSDG Policy Brief(link is external)), and most significant socio-economic disruption has occurred in cities. The pandemic has exposed the “soft underbelly” of our urban development, governance and risk management systems.

More than ever before, a multitude of risks are manifesting themselves with higher frequency, greater magnitude and cascading impacts in cities. According to UNDRR(link is external), nearly 84 percent of the fastest growing cities face extreme climate and disaster risks; the vast majority of which are in Asia and Africa. This disconcerting scenario is compounded by the location of many high-risk cities in challenging development contexts such as least developed countries (LDCs), low-income countries (LICs) and Small Island Developing States (SIDs), coupled with considerable governance deficits and resource constraints. In fact, the World Bank projects that COVID-19 may have pushed an additional 88 million to 115 million people into extreme poverty, with a majority engaged in informal services and living in congested urban settings.
...
First, UNDP will give more focus to neglected geographies where greatest capacity gaps exist, such as small, medium and transitioning cities in LDCs, low- and middle-income countries and SIDS, including cities in or on margins of crisis/fragile contexts. UNDP’s risk assessment tools such as its Crisis Risk Dashboard(link is external) will be strengthened to make better use of data in risk atlases, while initiatives like the European Commission’s INFORM(link is external) as well as UNDP and the Government of Japan’s Global Centre for Disaster Statistics(link is external) (GCDS) will provide actionable risk analysis and information to support risk management and resilience building needs.
