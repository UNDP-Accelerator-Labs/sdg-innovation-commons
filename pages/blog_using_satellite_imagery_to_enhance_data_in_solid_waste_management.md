...
[[source:https://www.undp.org/tanzania/blog/using-satellite-imagery-enhance-data-solid-waste-management]]

[Original article published here](https://www.undp.org/tanzania/blog/using-satellite-imagery-enhance-data-solid-waste-management)
...
The following steps were undertaken; 1) creation of a task on the open street map platform www.tasks.hotosm.org to divide the pilot area into several squares for mapping 2)open imagery sources such as Bing and Maxar were used 3)mapped images were reviewed and validated by a GIS expert 4)data was finally uploaded on the OpenStreetMap platform.
...
For more information about UNDP Accelerator LabProgramme visit: https://acceleratorlabs.undp.org
