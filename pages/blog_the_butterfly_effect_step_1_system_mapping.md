# The Butterfly Effect, Step 1: System Mapping

[[type:blog]]

[[source:https://www.undp.org/ukraine/blog/butterfly-effect-step-1-system-mapping]]

[Original article published here](https://www.undp.org/ukraine/blog/butterfly-effect-step-1-system-mapping)
...
Roman Minin mural - Artwork in Myrnograd, Donetsk Oblast (photo by Alisa Bankivska)
...
Fig. 1. Initial kumu.io visualisation of data.
...
Fig. 2. Kumu.io visualisation of data including both large- and small-scale organisations, and linked by relationships to one another.
...
Fig. 3. Alternative big Chervonograd employers shown with data from the CID’s unified big data platform, https://cid.center/sme/
Alternative Chervonograd big employers: visualisation in kumu
The photo of one of the alternative city employers - Duna (photo by Oksana Udovyk)
...
Fig. 4. Alternative Myrnograd big employers shown with data from the CID’s unified big data platform, https://cid.center/sme/
Alternative Myrnograd big employers: visualisation in kumu
A screenshot of the webpage of the alternative city employee - APK invest
...
Fig. 6. Profits in Chervonograd shown with data from the CID’s unified big data platform, https://cid.center/sme/
Visualisation in kumu, with the size of the dots representing the size of the profit.
...
Fig. 7. Profits in Myrnograd shown with data from the CID’s unified big data platform, https://cid.center/sme/
Visualisation in kumu, with the size of the dots representing the size of the profit.
...
Fig. 8. Myrnograd's top unprofitable entities.
...
Fig. 9. Debtors to local budget are mostly mine entities.
...
Roman Minin mural - Artwork in Myrnograd (photo by Alisa Bankivska)
Food Cluster in Myrnograd (photo shared by the Food Cluster - https://www.facebook.com/cxid.eco).
...
Churches in Chervonograd (photo by Alisa Bankivska).
...
Potocki Palace (photo by Alisa Bankivska).
How You Can Help
...
We decided to assess the environmental condition of the pilot coal mono-cities of Chervonohrad and Myrnohrad in order to find effective solutions that could impro...
READ MORE
United Nations
