...
[[source:https://www.undp.org/turkiye/blog/daring-be-different-affirmative-action-through-innovation]]

[Original article published here](https://www.undp.org/turkiye/blog/daring-be-different-affirmative-action-through-innovation)
...
Author
GÖKÇE TUNA
en: Head of Exploration tr: Keşif Yöneticisi
...
The very same norms that have held them back will continue to hold others back if they are not tackled now; because norms, by definition, are very difficult to change or take too long. Look how long it took for violence against women and girls (VAWG) to be recognised as a crime[4].
There are many occasions one can justify affirmative action to undo the wrongs of the past, yet it is incredibly rare to see a good example especially in the area of gender equity[5].
What I hope will leave a good and replicable legacy behind is our recent Social Innovation Challenge, launched in December 2020 in partnership with various ecosystem actors, inviting all women innovators to create solutions to urban challenges that can be scaled up/out/deep[6]. Solutions that have the potential to transform systems, or at least some sub-systems, towards achieving what we call sustainable development. The initiative is also an example of gender-responsive programming in which specific needs of women and girls are catered for.
...
[5] There are many initiatives where women are beneficiaries, but that is not necessarily affirmative action towards gender equity. Affirmative action prioritizes disadvantaged groups in certain areas, it is an intentional move to create fair conditions. To illustrate with an example, there is a big difference between providing women with leadership training and reserving at least 50% of leadership positions for women through quotas. In the former, there is no guarantee that women will be in leadership positions whereas in the latter this is guaranteed.
[6] See our innovation scaling strategy, available at: https://acceleratorlabs.undp.org/content/acceleratorlabs/en/home/library/AccLabSCALE.html
BLOG
A Do-It-Yourself Approach to Energy Efficiency Assessment
READ MORE
BLOG
The Challenge of Designing an Innovation Challenge – Part II
Following on from the previous blog in this series where I shared various insights on how to get the basics of an innovation challenge right, this blog post is ab...
READ MORE
BLOG
