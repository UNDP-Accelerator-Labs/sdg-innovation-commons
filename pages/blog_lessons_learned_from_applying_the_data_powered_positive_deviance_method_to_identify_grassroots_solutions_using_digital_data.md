...
[[source:https://www.undp.org/acceleratorlabs/publications/lessons-learned-applying-data-powered-positive-deviance-method-identify-grassroots-solutions-using-digital-data]]

[Original article published here](https://www.undp.org/acceleratorlabs/publications/lessons-learned-applying-data-powered-positive-deviance-method-identify-grassroots-solutions-using-digital-data)
...
Gina Lucarelli for their

feedback, as well as to

Amy Elizabeth Bennett

for her editing.

GIZ Data Lab, UNDP Accelerator Labs,

University of Manchester. Oct. 2021
...
Towards tackling deforestation in Ecuador

Towards making public spaces safer for women in Mexico

Towards increasing agricultural productivity in Niger

Towards maintaining pastoral livelihoods in Somalia

Six Learnings from the Pilots

Learning 1: Remain flexible in the face of data unavailability

Learning 2: Leverage existing partnerships for data access

Learning 3: Map and fill know-how gaps early

Learning 4: Scale with caution

Learning 5: Look at deviance over time

Learning 6: Look beyond individual or community practices and behavior
...
(DPPD) initiative, a global collaboration between the GIZ

Data Lab, the UNDP Accelerator Labs Network, the Uni-

versity of Manchester Center for Digital Development, and

UN Global Pulse Lab Jakarta. The pilots seek out grassroots

solutions to development challenges that range from the

interaction between livestock farming and deforestation

to gender-based violence and insecurity in dense urban

environments in Ecuador, Mexico, Niger and Somalia. The

learnings relate to the early stages of the DPPD method,

originally proposed by Albanna & Heeks [1], and focus
...
Remain flexible in the face of data unavailability

Leverage existing partnerships for data access
...
Look at deviance over time

Look beyond individual or community
...
cover successful local solutions to development challenges.
...
T he Data Powered Positive Deviance

(DPPD) initiative is established on the

concept of Positive Deviance [2], which as-
...
sumes that in every community there are in-

“positive deviants” employed them. By sup-

dividuals or groups who develop unconven-

porting other families to adopt such prac-

tional practices that help them deal better

tices, Sternin and colleagues claim to have

with challenges than their peers. The goal of

impacted the lives of two million people by

the Positive Deviance approach is to identi-

the turn of the century.

fy these people, to understand what makes

Recent developments in the avail-

them and their practices different and suc-

ability of digital data offer an unprecedent-

cessful, and to mobilize the rest of their

ed opportunity to look for positive deviants

communities to emulate those practices.

across large geographical areas and analyze

Its origins date back to the 1990s,

their performance over time. The integration

and the work of Sternin and colleagues [3]

of such novel data sources to complement

on child malnutrition in Northern Vietnam.

traditional data sources used in the Positive

Their idea was simple: flip the logic of tra-

Deviance approach is what we refer to as the

ditional development efforts. Rather than

Data Powered Positive Deviance method.

spend time, effort and money on bringing

This method can be regarded as a new tool

resources into communities from the out-

for development professionals and Positive

side, Sternin and colleagues decided to seek
out and scale solutions to malnutrition that

Deviance practitioners alike to identify what
works and why, by mixing analytical insights

might exist on the inside. The team found

from traditional and non-traditional data.

families who were able to keep their children

The DPPD method* is based on a

properly nourished, while others around

paper by Albanna and Heeks [1], in which

them could not. They learned that caregivers

the authors suggest it should help identify

in these families would add small shellfish

positive deviants in new and more general-

and sweet-potato greens to their children’s

ized ways because of the geographic, de-
...
associated with the adoption of a method

development issues in different contexts.

that uses non-traditional data sources in a

This report covers learnings of the

bottom-up approach to build on a commu-

first two stages of the DPPD method (Table

nity’s inherent assets and capabilities as the

1) which are concerned with defining the

starting point in the search for solutions.

problem to be tackled and the desired out-

come as well as the identification of poten-

tial positive deviants. It is based on lessons

learned from the ongoing pilot projects that

are introduced in the following section. The

six key learnings are then presented and
...
in this report mainly relate to the first two stages (highlighted).
...
W e are testing the DPPD method with local teams in Ecuador, Mexico, Niger and
...
lower gender-based crime reports
...
Table 2. Overview of the four pilot projects in Ecuador, Mexico, Niger and Somalia.
...
Agricultural practices are one of the main causes of deforestation in
...
T en months into the pilots, all teams—including the global coordination team—took
...
There is value in mapping out data landscapes early on as it can help
...
detailed training sets for land cover analysis from the Ministry of

Environment and cadaster data from the national agricultural survey.
...
analysts who were able to combine quantitative data skills with an
...
that the “positive” outcomes are due to individual- or group-level
...
comes one, or who stops being one can inform on the determinants

of high performance, but also on factors that might reduce positive

deviance or evoke any other transition from one deviant state to

another. Further, we believe that by observing contextual factors

and performance over time, it will be possible to better under-

stand the sustainability of positively deviant practices, as well as

their interaction with other extrinsic factors (not indvidual or group
...
ports do not necessarily mean lower incidences of violence—but we
...
T his report presents six learnings from
...
The DPPD Initiative
The Data Powered Positive Deviance initiative

is a global collaboration between the GIZ Data

Lab, the UNDP Accelerator Labs Network, the

University of Manchester Centre for Digital

Development, and UN Global Pulse Lab Jakarta.

It is dedicated to finding, understanding and

scaling local solutions to development challenges

through the use of digitally recorded, readily

available quantitative and qualitative data.

Resources
Data Powered Positive Deviance on Medium:

https://dppd.medium.com/

GIZ Data Lab Blog:

https://www.blog-datalab.com/

UNDP Accelerator Labs on Medium:
...
Andreas Glücker (GIZ Data Lab):

andreas.gluecker@giz.de
