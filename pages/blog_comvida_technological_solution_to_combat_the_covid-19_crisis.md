# COMVIDA technological solution to combat the COVID-19 CRISIS

[[type:blog]]

[[source:https://www.undp.org/acceleratorlabs/blog/comvida-technological-solution-combat-covid-19-crisis]]

[Original article published here](https://www.undp.org/acceleratorlabs/blog/comvida-technological-solution-combat-covid-19-crisis)
...
COMVIDA technological solution to combat the COVID-19 CRISIS COMVIDA uma Solução Tencológica no combate à COVID19 em Cabo Verde
April 15, 2020

Author: Samory Araújo, Head of Solutions Mapping, UNDP Cabo Verde Accelerator LabThis article was original published at here(link is external).
COMVIDA uma Solução Tencológica no combate à COVID19 em Cabo VerdeComvida e o site contaram com a parceria do PNUD que através do Accelerator Lab trabalhou com um grupo de jovens inovadores que fazem parte da Cabo Verde.Foto | Governo de Cabo Verde“We didn’t know then what we know now – that a new virus would emerge that would bring many parts of society to a standstill…” WHO Director-General
Context
...
The Website www.covid19.cv(link is external) is the official communication channel where the citizen can consult the general map of positive cases, the official information and communications from the Government and various information on how to protect themselves.
Prevention
...
Besides the Website www.covid19.cv(link is external) the project COMVIDA has the mobile application app.convid19.cv is available in three versions
...
Links:
Website www.covid19.cv(link is external)
APP app.convid19.cv
--- content ---
