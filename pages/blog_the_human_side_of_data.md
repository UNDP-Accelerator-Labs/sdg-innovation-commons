...
[[source:https://www.undp.org/acceleratorlabs/blog/human-side-data]]

[Original article published here](https://www.undp.org/acceleratorlabs/blog/human-side-data)
...
For example, combining satellite imagery with GIS and crowdsourcing modalities enabled our Lab in Ukraine(link is external) to map open burning activities in rural areas. At first, the Lab set out to understand the frequency and locations at which open burning occurs but soon realized that the picture is incomplete without knowing why burning occurs in the first place. Thus, they partnered up with community and grassroots groups to conduct multiple micro-sensemaking workshops with the aim to give the mapped patterns a more contextual reading.Photo by Moritz Bruder on Unsplash
...
Recently, we featured our work in collective intelligence and waste during a co-creation workshop for the Global Festival of Action(link is external) and had 1500 people registered, close to 500 people on the workshop, and many more in the live stream (recording here(link is external)). (Wow!). Working with the crowd and opening up our practice to a wider audience demonstrates the growing demand of citizens and the public to be part of solving and adding their expertise to the problems that affect them.
