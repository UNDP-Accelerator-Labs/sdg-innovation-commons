...
[[source:https://www.undp.org/acceleratorlabs/blog/exploring-our-futures-today]]

[Original article published here](https://www.undp.org/acceleratorlabs/blog/exploring-our-futures-today)
...
Exploring Our Futures, Today. Exploring Our Futures, Today.
February 23, 2021

Author: Jennifer Hotsko, Head of Exploration, UNDP Panama Accelerator Lab
...
So, you think you’re ready? If you’re eager to implement Our Futures game in a local context, Panama’s Accelerator Lab recommends participating in a workshop first. It’s a perfect way to get your feet wet and even interact with other futures-literate participants and professionals that can guide the process. Follow any of the following organizations to stay abreast of potential events happening in the near future (no pun intended) Journal of Futures Studies(link is external) , Participatory Futures(link is external), and Action Foresight(link is external). Next, we suggest moving onto the facilitation stage which allows you to understand the game further as you guide participants. And finally, be sure to bring others along as you build a community that supports long-term goals towards building desirable futures. After all, as UNESCO Chair for Futures Literacy, Loes Damhof, says, “If everybody uses the future, everybody anticipates.”(link is external) Once you have acquired the capability, it’s “hard to not see different futures and to only focus on one.”
...
In addition to the core literature behind Our Futures game(link is external) and previously mentioned organizations throughout the article, there are a number of other organizations with plenty of information to satiate even the most curious futures thinker, including:, World Future Society(link is external), World Futures Studies Federation(link is external), Institute for the Future(link is external), and the Millennium Project(link is external).
