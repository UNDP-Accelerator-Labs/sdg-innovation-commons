# Experimenting with a New Approach - Part II

[[type:blog]]

[[source:https://www.undp.org/lebanon/blog/experimenting-new-approach-part-ii]]

[Original article published here](https://www.undp.org/lebanon/blog/experimenting-new-approach-part-ii)
...
Today in Lebanon, people’s faith in the government is declining, their fatigue is rising, and the political and economic anxieties grow with each passing day. Wha...
READ MORE
BLOG
Accompanying the Lebanese people along their recovery journey
The explosion in the port on August 4 continues to shake the lives of people in Beirut and across Lebanon. In the aftermath of the disaster, UNDP is focusing on m...
READ MORE
BLOG
Experimenting with a New Approach - Part I
This is a two-part blogpost outlining the past, present, and future of UNDP Lebanon’s Accelerator Lab. The first part covers our approach during the first several...
READ MORE
BLOG
Managing Risks in Times of Compounded Crises: Leveraging the Collective to Accelerate Solutions
Within the same sensemaking process we had launched previously, we organized a third plenary session bringing together all 40 participants from the previous works...
READ MORE
BLOG
Lebanon’s Accelerator Lab: An Iterative Role
UNDP Lebanon was set to launch its own Accelerator Lab mid-2019. The were launched globally in July 2019 with the aim of building the world's largest and fastest...
READ MORE
United Nations
