# Aprendizaje para el Desarrollo: ¿qué funciona y qué no?

[[type:blog]]

[[source:https://www.undp.org/es/paraguay/blog/aprendizaje-para-el-desarrollo-que-funciona-y-que-no]]
...
Aprendizaje para el Desarrollo: ¿qué funciona y qué no?
Pobreza extrema(link is external) en aumento, transporte urbano ineficiente, deforestación creciente de las reservas forestales(link is external), desempleo juvenil(link is external) en torno al 50%: son solo algunos de los titulares que dominan nuestra discusión día a día en Paraguay. Son problemas persistentes y que interactúan entre sí de manera compleja y dinámica.
...
Acción y aprendizaje son dos orientaciones complementarias, siempre presentes en las iniciativas para el desarrollo.Frente a la rapidez y dinámica de los desafíos, sin embargo, no siempre creamos el espacio para reflexionar sobre nuestras acciones y los aprendizajes que producen. Y eso dificulta nuestra capacidad para innovar desde la evidencia.¿Cómo integramos el aprendizaje a la acción desde el PNUD?
Para integrar mejor estas dos orientaciones, en el 2019 nacen los Laboratorios de Aceleración del PNUD(link is external) (AccLab), una red global con 60 laboratorios alrededor del mundo. Los laboratorios representan un espacio formal de aprendizaje desde el PNUD, cuyo objetivo es acelerar la identificación y adopción de políticas y prácticas de desarrollo efectivas.
Paraguay es uno de los 7 países en Latinoamérica que forman parte de esta red. Lanzamos nuestro AccLab (el AccLabPY) en octubre de 2019, conformando un equipo interdisciplinario que integra conocimientos y experiencias desde las ciencias sociales(link is external), la tecnología(link is external) y los negocios(link is external).
...
A través de estos ciclos, la lógica de aprendizaje se integra armoniosamente a la lógica de acción que se espera de los programas y proyectos para el desarrollo.Desde lo abstracto a lo concreto: los primeros pasos del AccLabPY
...
Estos son los primeros pasos de un proceso de análisis que involucra dos ejercicios de aprendizaje: en primer lugar derivar el sentido estratégico del portfolio de proyectos del PNUD en Paraguay (Portfolio Sensemaking(link is external)), y en segundo lugar analizar las iniciativas vigentes orientadas a la definición de desafíos de desarrollo del país (Horizon Scanning(link is external)). El fin de estos ejercicios es identificar los desafíos que priorizaremos durante los próximos años.
...
Queda poco tiempo para alcanzar los objetivos que nos propusimos lograr para el 2030. Como nunca, necesitamos acelerar el desarrollo económico y social, aprendiendo a innovar continuamente con el fin de no dejar a nadie atrás. Esta es nuestra misión y te invitamos a que seas parte.Read this blog post in english here(link is external).
