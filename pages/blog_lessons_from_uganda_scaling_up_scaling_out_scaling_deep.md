...
[[source:https://www.undp.org/uganda/blog/lessons-uganda-scaling-scaling-out-scaling-deep]]

[Original article published here](https://www.undp.org/uganda/blog/lessons-uganda-scaling-scaling-out-scaling-deep)
...
Lessons from Uganda: Scaling Up, Scaling Out, Scaling Deep
AUGUST 30, 2022
The Accelerator Lab network is the world’s fastest learning network on development challenges
UNDP Uganda
...
UNDP Uganda Accelerator Lab team introduces partners to the Accelerator Lab methodology
UNDP Uganda
...
UNDP and Uganda Electricity Regulatory Authority (ERA) staff inspect the newly installed electrical system at Mwanamugimu Nutrition Unit in Uganda’s National Referral (Mulago) Hospital
UNDP Uganda
