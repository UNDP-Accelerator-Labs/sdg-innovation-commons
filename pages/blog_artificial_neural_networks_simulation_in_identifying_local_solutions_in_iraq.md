...
[[source:https://www.undp.org/iraq/blog/artificial-neural-networks-simulation-identifying-local-solutions-iraq-1]]

[Original article published here](https://www.undp.org/iraq/blog/artificial-neural-networks-simulation-identifying-local-solutions-iraq-1)
...
Case 1: The ANNs simulation system in Matlab; the input side represents the common challenges of employment in Iraq, the output side represents the consequences of the inputs on the graduates brain. The inputs and outputs are the training data for ANNs.
...
Case 1 results: The consequences of the overrated realistic negative ideas of employment on 10 graduates' brains as samples out of 210 surveyed.
...
Case 2: The ANNs simulation system in Matlab; the first input represents the common challenges of employment in Iraq, the second input represents the characteristics of the life-changing events in graduates' journey. The output side represents the consequences of the inputs on the graduates brain. The inputs and outputs are the training data for ANNs.
...
Case 2 results: The consequences of the life-changing events related to employment on 10 graduates' brains as samples out of 129 surveyed.
...
Case 3: The ANNs simulation system in Matlab; the first input represents the common challenges of employment in Iraq from Case1, the second input represents the characteristics of seven local solutions related to employment similar to the characteristics of life-changing events from case2. The output side represents the consequences of the inputs on the graduates brain. The inputs and outputs are the training data for ANNs.
...
Case 3 results: The consequences of the local solutions characteristics related to employment on 10 graduates' brains as samples out of 210 surveyed.
Takeaways
