# Human Rights Based Approach to Development Planning Toolkit

[[type:publications]]

[[source:https://www.undp.org/philippines/publications/human-rights-based-approach-development-planning-toolkit]]

[Original article published here](https://www.undp.org/philippines/publications/human-rights-based-approach-development-planning-toolkit)
...
UNDP's core resources have had a profound impact on our development work across the Philippines.
...
UNDP Philippines is dedicated to ensuring a high quality of our services in all the locations where we operate. If you have been adversely affected and/ or would like to report issues regarding UNDP’s activities in Indonesia, your concerns can be submitted in the links below.

The toolkit is a step-by-step guide for development planners and practitioners that strengthens the capacities of the many actors at both national and locallevels of government to apply a rights-based approach to development planning and programming.
The National Plastic Action Partnership (NPAP) Philippines proudly launches its inaugural newsletter which provides an overview of project milestones in its eff...
The SHIELD Programme Results: A Summary of Milestones 2022-2024 showcases the stories of resilience, innovation, and collaboration from across the Philippines. ...
Unifying Pathways, Linkages, and Inclusive Facilitation of Transformative Services for Decommissioned Combatants Project (UPLIFT DC)[P510557] ENVIRONMENTAL and...
Over a three-period, the Programme on Assistance for Camp Transformation through Inclusion, Violence Prevention, and Economic Empowerment (PROACTIVE), worked wi...
...
The Tambuli is a periodic publication of the Australia-supported Strengthening Institutions and Empowering Localities Against Disasters and Climate Change (SHIE...
current selection
