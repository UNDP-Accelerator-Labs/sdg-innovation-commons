...
[[source:https://www.undp.org/acceleratorlabs/blog/e-commerce-cabo-verde-mirage]]

[Original article published here](https://www.undp.org/acceleratorlabs/blog/e-commerce-cabo-verde-mirage)
...
Thus, the project called – Marketplace de Artesanato, trained artisans in various aspects of e-commerce: use of social networks (Facebook and Instagram), photography techniques adapted to digital, e-commerce platforms and digital marketing. We bet on an African e-commerce platform - Afrikrea.com(link is external) – for the practical dimension of creating online stores.
...
Afrikrea offers as an alternative to other platforms such as ETSY(link is external), the world leader in selling handicrafts, the possibility of "traditional" international bank transfer. That is, AFRIKREA(link is external) receives the amount from the buyer via online payment and then transfers the amount to the seller's bank account.

Most sites only operate with money transaction systems that do not work in Cabo Verde such as the well-known PayPal(link is external), which works as a digital wallet.

We highlighted the Cabo Verdean post office – Correios de Cabo Verde(link is external) – , for being up to the task of allowing easily, quickly and at reasonable cost the sending of any package both nationally and internationally.
...
As for practical results, Joceline Ferreira realized the advantages of being present on social networks and started to boost them, having one of her videos(link is external) on Tiktok viralized with a reach of 2.5M views and today she has 28K followers which also increases her sales. Ileize Varela says her photos have come alive and increased her number of followers and consequent sales, not in the craft area, but in her confectionery business. - NatuXok | Instagram(link is external)

Artisans such as DaGraça, increased their sales nationally through facebook Maria Da Graça Correia | Facebook(link is external) - and Mizé Varela - Mize Acessórios | Afrikrea(link is external) - and Jocelina Ferreira - Nharti | Afrikrea(link is external) - are now selling internationally through Afrikrea.
...
Big players like PayPal(link is external), Payoneer, Revolut, Pix, mPesa (African platform), which are intermediary digital wallets with banks, work with standard systems that interact with banks.
