# The top 3 lessons we’ve learnt so far…

[[type:blog]]

[[source:https://www.undp.org/nepal/blog/top-3-lessons-weve-learnt-so-far]]

[Original article published here](https://www.undp.org/nepal/blog/top-3-lessons-weve-learnt-so-far)
...
The Accelerator Lab worked closely with the local governments of Kathmandu, Bhaktapur, Kirtipur and Lalitpur Municipality to develop a GIS-enabled mobile app to collect real time data on the current usage status, land location, area covered and available facilities of open spaces.Since August 2019, we at UNDP’s Accelerator Lab have been mapping and exploring grassroots solutions that hold the potential to tackle the complex issues of unplanned urbanization(link is external) and youth unemployment(link is external). In Kathmandu, we came across individuals who have been working for open spaces and dealing with youth unemployment related issues. We were able to secure partnerships with innovators, community-led organizations and the local government(link is external). In doing so, some of our hypotheses were tested, such as those related to data driven policies, ways of identifying grassroots innovators, and the scope of the lab on the national level. Here are a few of our learnings:
