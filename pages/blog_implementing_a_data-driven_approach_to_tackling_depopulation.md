...
[[source:https://www.undp.org/serbia/blog/implementing-data-driven-approach-tackling-depopulation]]

[Original article published here](https://www.undp.org/serbia/blog/implementing-data-driven-approach-tackling-depopulation)
...
DRAŠKO DRAŠKOVIĆ
Head of Exploration
Depopulation in Serbia is a complex challenge with multiple root causes, linked to multiple societal problems. To solve it, we need to approach it in an integrated way. At UNDP Accelerator Lab Serbia, we use new sources of data to understand this challenge more quickly and come up with new solutions.
...
Diaspora is an invaluable asset to its country of origin. The potential of people in the diaspora lies in their education, professional experience and professiona...
READ MORE
United Nations
