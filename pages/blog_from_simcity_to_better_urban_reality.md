...
[[source:https://www.undp.org/serbia/blog/simcity-better-urban-reality]]

[Original article published here](https://www.undp.org/serbia/blog/simcity-better-urban-reality)
...
FROM ‘SIMCITY’ TO BETTER URBAN REALITY
From ‘SimCity’ to better urban reality
How “digital twins” of real cities can help guide innovation and transform our lives
DECEMBER 27, 2022
Author
DRAŠKO DRAŠKOVIĆ
Head of Exploration
...
According to Accenture’s Tech Trends 2022 report, the global digital twin market is expected to grow from $3.21 billion in 2020 to $184.5 billion by 2030. Digital twins are also finding their way into the public sector and especially urbanism – just as it was predicted by SimCity and Sims games.
...
Many of these digital twins are made possible by a multitude of sensors that track real-world data and movement. Take for example workers at factories with digital twins that may find their every movement followed while a hacker of a digital twin could gain frighteningly precise knowledge about how a system works and what its vulnerabilities are. These risks can be compounded if they are related to citizens who are not aware of what data is collected about them, or management of key infrastructure systems such as, energy, heating or water supply .
...
All of these challenges require both top-down (e.g. setting up centres to coordinate and manage all data) and bottom-up approaches (e.g. what do the citizens and other key stakeholders think are most important things to model), and all application scenarios need to be human-centric.
...
However, I believe that, through the use of precise mapping, integration and constant interplay between virtual and physical cities , monitoring, as well as their power for making predictions for various scenarios, digital twin cities can provide us with innovative solutions for a sustainable future. I also believe that, like in a game, there will be no losers in the city of tomorrow, and that our urban environment will become sustainable, more convenient and more inclusive.
United Nations
