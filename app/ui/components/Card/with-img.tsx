...
export default function Card({
    ...
    //     await platformApi({ action: 'download', render: true, output: 'csv'  },  'solution', 'pads')
    // }

    // const engage = async ( platform: string, action: string, id: number, type: string )=> {
    //     const data = await engageApi(platform, type, action, id, )
                ...
                <div>
                    ...
                    <div className="self-stretch flex flex-row items-center justify-between text-sm mb-[10px]">
                        <div className="flex flex-row items-start gap-5">
                            <button  className="flex flex-row items-start justify-start bg-inherit hover:text-light-green">
                        ...
                        <div className="flex items-end justify-items-end cursor-pointer ">
                            <button className="w-[40px] h-[40px] border-solid border-black border-[1px] bg-[transparent] hover:text-light-green">
