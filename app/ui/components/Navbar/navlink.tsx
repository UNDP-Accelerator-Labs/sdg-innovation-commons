...
const NavLink: React.FC = () => {
  return (
    <div className='md:mt-[20px] lg:mt-0 self-stretch flex flex-col items-start justify-start gap-1'>
      {navItems.map((item) => (
        <div key={item.title} className='self-stretch flex flex-row items-start justify-start'>
          <div className='flex-1 rounded-md overflow-hidden flex flex-row items-center justify-start md:py-[10px] lg:py-[20px] px-8 gap-2'>
